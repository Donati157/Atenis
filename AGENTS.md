...
Se você é uma IA (Codex, GPT, Cursor) lendo isto pra ajudar com uma tarefa: comece pelo **glossário** (logo abaixo), depois vai direto pro **walkthrough do system prompt em camadas** (seção 7) — é o coração do produto. Pra mexer em código, use o **cookbook** (seção 12).
...
## Como conversar comigo (Codex/IA)
...
`~/.Codex/projects/-Users-davidonati-Documents-Codex-Projects-Edu-Iceberg/memory/MEMORY.md`
